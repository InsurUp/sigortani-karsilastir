...
export const metadata: Metadata = {
  title: "Kasko Sigortası Teklif Al - Kapsamlı Araç Koruması | Sigortanı Karşılaştır",
  ...
  alternates: {
    canonical: "https://sigortanikarsilastir.com/kasko-teklif"
  },
  openGraph: {
    title: "Kasko Sigortası Teklif Al - Kapsamlı Araç Koruması | Sigortanı Karşılaştır",
    description: "Aracınız için kapsamlı kasko sigortası tekliflerini hızlıca alın. Online poliçe oluşturun ve aracınızı güvence altına alın.",
    url: "https://sigortanikarsilastir.com/kasko-teklif",
    type: "website"
  },
  twitter: {
    title: "Kasko Sigortası Teklif Al - Kapsamlı Araç Koruması | Sigortanı Karşılaştır",
