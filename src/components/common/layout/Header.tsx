          ...
          <nav className="hidden lg:flex items-center gap-5 xl:gap-8">
                        ...
                        <div className="absolute top-full left-0 pt-2 z-[99999]">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            {/* Aracım ve Evim kategorileri */}
                              ...
                              <div key={category.title} className="rounded-xl border border-slate-200 bg-slate-50/70 p-3">
                                ...
                                <ul className="space-y-2">
                                  {category.items.map((product) => (
                                    <li key={product.name}>
                                      <Link
                                        href={product.href}
                                        className="block rounded-lg border border-transparent bg-white px-3 py-2 text-sm font-semibold text-slate-800 transition-all duration-200 hover:border-red-200 hover:bg-red-500 hover:text-white"
                                      >
                                        {product.name}
                                      </Link>
                                    </li>
            ...
            <div className="flex items-center gap-2 xl:gap-3">
              ...
              <Link 
                ...
                target="_blank"
                className="bg-white text-green-500 border border-green-500 px-3 py-2 rounded-full hover:bg-green-500 hover:text-white active:scale-95 transition-all duration-200 flex items-center gap-1.5 font-semibold text-xs whitespace-nowrap"
              >
              ...
              {/* Phone Button */}
              <Link 
                href="tel:05330864001"
                className="bg-white text-red-500 border border-red-500 px-3 py-2 rounded-full hover:bg-red-500 hover:text-white active:scale-95 transition-all duration-200 flex items-center gap-1.5 font-semibold text-xs whitespace-nowrap"
              >
                <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {isLoggedIn ? (
                <Link href="/dashboard" className="bg-secondary text-white px-5 py-2 rounded-full hover:bg-opacity-90 active:scale-95 transition-all duration-200 font-semibold text-xs whitespace-nowrap min-w-[90px] text-center">
                  Hesabım
                </Link>
              ) : (
                <Link href="/giris-yap" className="bg-secondary text-white px-5 py-2 rounded-full hover:bg-opacity-90 active:scale-95 transition-all duration-200 font-semibold text-xs whitespace-nowrap min-w-[90px] text-center">
                  Giriş Yap
                </Link>
              )}
            </div>
                              ...
                              {productCategories.map((category) => 
                                category.items.map((product) => (
                                  <li key={product.name}>
                                    <a
                                      href={product.href}
                                      className="block rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm font-semibold text-slate-800 transition-all duration-200 hover:border-red-200 hover:bg-red-500 hover:text-white"
                                      onClick={() => setIsMenuOpen(false)}
                                    >
                                      {product.name}
                                    </a>
