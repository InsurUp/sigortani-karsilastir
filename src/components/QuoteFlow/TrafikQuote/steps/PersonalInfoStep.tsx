...
const BANNER_PREFILL_KEY = OFFLINE_FORM_CONFIG.trafik.storageKey;
...
const FORM_CONFIGS: Record<CustomerType, FormFieldConfig> = {
  [CustomerType.Individual]: {
    ...
    fields: {
      ...
      email: { required: false, label: 'E-posta' },
...
const PersonalInfoStep = ({ onNext, onBack, isFirstStep, isLastStep }: PersonalInfoStepProps) => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn('Trafik banner prefill verisi okunamadı:', prefillError);
    } finally {
