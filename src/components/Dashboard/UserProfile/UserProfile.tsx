...
const UserProfile = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // CustomerId kontrolü
      if (!customerId) {
        console.error('customerId bulunamadı!');
  ...
  return (
    <div className="px-5 py-5 md:py-8">
      <div className="mb-6 md:mb-8">
        <h3 className="text-xl md:text-2xl font-bold text-gray-900">Bilgilerim</h3>
      ...
      <div className="shadow-xs rounded-xl border border-gray-100 bg-white p-4 md:p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="mt-8 flex justify-end">
            <button
              type="submit"
              className="rounded-lg px-6 py-2.5 font-medium text-white transition-colors hover:opacity-90 disabled:opacity-70 bg-secondary border border-secondary"
              disabled={loading}
