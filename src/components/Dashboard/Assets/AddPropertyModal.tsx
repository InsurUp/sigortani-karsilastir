    ...
    <div className="fixed inset-0 z-999 flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div className="max-h-[95vh] w-full max-w-4xl overflow-y-auto rounded-xl bg-white p-4 md:p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
          ...
          {/* UAVT/Adres Bilgileri */}
          <div>
            <h5 className="mb-3 md:mb-4 font-medium text-gray-900 text-sm md:text-base">Adres Bilgileri</h5>
          ...
          {/* Genel Bilgiler */}
          <div>
            <h5 className="mb-3 md:mb-4 font-medium text-gray-900 text-sm md:text-base">Genel Bilgiler</h5>
            <div className="grid grid-cols-1 gap-4 md:gap-6 md:grid-cols-2">
              <Input
                label="Metrekare"
                type="text"
          ...
          <div>
            <h5 className="mb-3 md:mb-4 font-medium text-gray-900 text-sm md:text-base">Konut Kullanım Detayları</h5>
            <div className="grid grid-cols-1 gap-4 md:gap-6 md:grid-cols-2">
              <div>
                <CustomSelect
