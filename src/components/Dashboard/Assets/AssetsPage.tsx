    ...
    <div className="shadow-xs group relative rounded-xl border border-gray-100 bg-white p-4 md:p-6 transition-shadow hover:shadow-md min-h-[120px] md:min-h-[140px]">
      <div className="flex items-start space-x-3 md:space-x-4 pr-8">
        ...
        <div className="flex-1 min-w-0">
          <span className="font-medium text-gray-900 text-sm md:text-base leading-tight break-words">{title}</span>
    ...
    >
      <div className="flex items-start space-x-3 md:space-x-4">
        ...
        <div className="flex-1">
          <span className="font-medium text-gray-900 text-sm md:text-base">Yeni Varlık Ekle</span>
  ...
  return (
    <div className="px-5 py-5 md:py-8">
      <div className="mb-6 md:mb-8">
        <h3 className="text-xl md:text-2xl font-bold text-gray-900">Varlıklarım</h3>
