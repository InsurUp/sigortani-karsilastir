...
function HealthText() {
    return (
        <>
            <Banner text="Sağlık Açık Rıza Metni" />
            <section>
                <div className="container">
                    <article>
                        ...
                        <p className="ql-align-center text-center">
                            <strong>SİGORTALI/SİGORTA ETTİREN AÇIK RIZA METNİ - SAĞLIK</strong>
                        </p>
                        <p> 
                        ...
                        <p>
                            <strong style={{ fontSize: '16px' }}>SİGORTALI/SİGORTA ETTİREN ÖZEL NİTELİKLİ KİŞİSEL VERİLERİ</strong>
                        </p>
                        <p>
                        ...
                        <p>
                            <strong style={{ fontSize: '16px' }}>ÖZEL NİTELİKLİ KİŞİSEL VERİLERİNİZİN İŞLENME AMAÇLARI</strong>
                        </p>
                        <p>
                        ...
                        <p>
                            <strong style={{ fontSize: '16px' }}>ÖZEL NİTELİKLİ KİŞİSEL VERİLERİNİZİN YURT İÇİNDE AKTARIMI</strong>
                        </p>
                        <p>
                        ...
                        <p>
                            Sigortanı Karşılaştır Sigorta ve Aracılık Hizmetleri LTD. ŞTİ.
                        </p>
                        <p>
                            Mersis No: 0770108619900001
                        </p>
                        <p>
                            İletişim linki: <a href="https://www.sigortanikarsilastir.com" rel="noopener noreferrer" target="_blank" className="acerapps-text-editor-link">https://www.sigortanikarsilastir.com</a>
                        </p>
                        <p>
                            Adres: Adres: Hepkebirler Mah. Adalet Cad. No: 26 Merkez / Kastamonu
                        </p>
                        <p>
                            Tel <a href="tel:05330864001" rel="noopener noreferrer" className="acerapps-text-editor-link">+90 533 086 40 01</a>
                        </p>
                    </article>
                </div>
            </section>
