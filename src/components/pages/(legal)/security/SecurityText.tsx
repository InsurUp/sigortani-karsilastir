...
function SecurityPolicy() {
    return (
        <div>
            <Banner text="Gizlilik Sözleşmesi" />
            <section>
                <div className="container">
                    <article>
                        ...
                        <p className="ql-align-center">
                            <strong>Bilgi Güvenliği Politikası</strong>&nbsp;
                        </p>
                        <p>
                        ...
                        <p>
                            İş sürekliliğimize ve bilgi varlıklarımıza yönelik kapsam dahilinde ki her türlü riski yönetmek amacıyla; "bilgi güvenliği yönetim sistemimizin" gereklerini yerine getirecek şekilde dokümante edilmesi, denetlenmesi ve sürekli iyileştirilmesi, bilgi varlıklarına yönelik risklerin sistematik olarak yönetilmesi, bilgi güvenliği farkındalığını artırmak amacıyla çalışanlara teknik ve davranışsal yetkinlikleri geliştirecek eğitimlerin sağlanması için gerçekleştirdiğimiz faaliyetlerimizi, diğer yönetim sistemleri ile birlikte bütünleşik bir şekilde yönetmekteyiz.&nbsp;
                        </p>
                        <p>
                        ...
                        <p>
                            Bu Sözleşme ile ilgili olarak çıkabilecek bütün uyuşmazlıklarda öncelikle işbu metinde yer alan hükümler, hüküm bulunmayan konularda ise Türkiye Cumhuriyeti Kanunları uygulanacaktır. Sözleşme’nin uygulanmasından kaynaklanan ihtilafların çözümünde Kastamonu Mahkemeleri ve İcra Daireleri yetkili olacaktır.&nbsp;
                        </p>
                        <p>
